...
def verify_teacher_password():
    """
    Prompts for and verifies the teacher's password with visible input.
    """
    try:
        print("Please type your password and press Enter:")
        entered_password = input("Enter teacher password: ")
        ...
        print(f"An error occurred during password entry: {e}")
        return False
...
def main_app_menu():
    ...
    while True:
        ...
        print("1. Manage Students (Teacher Only)")
